<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManejarPermisos.aspx.cs" Inherits="InterfazUsuario.Admin.ManejarPermisos" %>
        ...
        <ContentTemplate>
            ...
            <table width="60%">
                <tr>
                    ...
                    <td >
                        <asp:ImageButton ID="ImageButtonNuevoPermiso" runat="server" ImageUrl="~/images/Nuevo.png" AlternateText="Nuevo Permiso" OnClick="ImageButtonNuevoPermiso_Click" />
            ...
            <hr />
                ...
                <asp:GridView ID="GridViewPermisos" runat="server" AutoGenerateColumns="False" Width="100%"
                    OnRowCreated="GridViewPermisos_RowCreated" OnRowCommand="GridViewPermisos_RowCommand"
                    EmptyDataText="No existen permisos" OnRowDataBound="GridViewPermisos_RowDataBound" AllowSorting="true">
                    <Columns>
                        <asp:BoundField HeaderText="Id" DataField="idpermiso" HeaderStyle-HorizontalAlign="Center"
                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="30" Visible="False">
                            <HeaderStyle HorizontalAlign="Center" Width="30px"></HeaderStyle>
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField HeaderText="Descripcion" DataField="despermiso" HeaderStyle-Width="300">
                          ...
                          <asp:TemplateField HeaderText="Opciones">
                            ...
                            <ItemTemplate>
                                <table style="width: 100%;">
                                    <tr>
                                        <td align="center">
                                            <asp:ImageButton ID="ImageButtonDetails" runat="server" CommandArgument='<%# Eval("idpermiso") %>'
                                                CommandName="Editar" ImageUrl="~/images/Editar.png" ToolTip="Editar información de {0}." />
                                            <asp:ImageButton ID="ImageButtonEliminar" runat="server" CommandArgument='<%# Eval("idpermiso") %>'
