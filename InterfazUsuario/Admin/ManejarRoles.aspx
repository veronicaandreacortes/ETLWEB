<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManejarRoles.aspx.cs" Inherits="InterfazUsuario.Admin.ManejarRoles" %>
        ...
        <ContentTemplate>
            ...
            <table width="60%">
                <tr>
                    ...
                    <td >
                        <asp:ImageButton ID="ImageButtonNuevoRol" runat="server" ImageUrl="~/images/Nuevo.png" AlternateText="Nuevo Rol" OnClick="ImageButtonNuevoRol_Click" />
            ...
            <hr />
                ...
                <asp:GridView ID="GridViewRoles" runat="server" AutoGenerateColumns="False" Width="100%"
                    OnRowCreated="GridViewRoles_RowCreated" OnRowCommand="GridViewRoles_RowCommand"
                    EmptyDataText="No existen roles" OnRowDataBound="GridViewRoles_RowDataBound" AllowSorting="true">
                    <Columns>
                        <asp:BoundField HeaderText="Id" DataField="idrol" HeaderStyle-HorizontalAlign="Center"
                            ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="30" Visible="False">
                            <HeaderStyle HorizontalAlign="Center" Width="30px"></HeaderStyle>
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:BoundField>
                        <asp:BoundField HeaderText="Descripcion" DataField="desrol" HeaderStyle-Width="300">
                          ...
                          <asp:TemplateField HeaderText="Opciones">
                            ...
                            <ItemTemplate>
                                <table style="width: 100%;">
                                    <tr>
                                        <td align="center">
                                            <asp:ImageButton ID="ImageButtonDetails" runat="server" CommandArgument='<%# Eval("idrol") %>'
                                                CommandName="Editar" ImageUrl="~/images/Editar.png" ToolTip="Editar información de {0}." />
                                            <asp:ImageButton ID="ImageButtonEliminar" runat="server" CommandArgument='<%# Eval("idrol") %>'
